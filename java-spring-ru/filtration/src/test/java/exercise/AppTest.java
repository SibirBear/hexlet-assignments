...
public class AppTest {
    ...
    // BEGIN
    @Test
    void testFilterByAllFields() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(get("/users?firstName=yac&lastName=attri&profession=Acc&gender=Male&email=blogspot.com"))
                .andReturn()
                .getResponse();
        ...
        User actualUser = actualUsers.get(0);
        assertThat(actualUsers.size()).isEqualTo(1);
        assertThat(actualUser.getFirstName()).isEqualTo("Hyacinthia");
        assertThat(actualUser.getLastName()).isEqualTo("Pattrick");
        assertThat(actualUser.getGender()).isEqualTo("Male");
        assertThat(actualUser.getProfession()).isEqualTo("Account Executive");
        assertThat(actualUser.getEmail()).isEqualTo("hpattrick1d@blogspot.com");
